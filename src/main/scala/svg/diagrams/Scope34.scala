...
object Scope34 extends App {
  ...
  (add5 :: scope5 :: add10 :: scope10 :: ec :: scopeec :: activate5 :: activate10 :: global :: path1 :: path2 :: path3 :: path4 :: path5 :: path6 :: path7 :: path8 :: path9 :: List[SvgGraph]()).map(_.render) foreach println
}
